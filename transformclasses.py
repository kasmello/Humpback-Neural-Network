...
class TimeWarp(nn.Module):
    def __init__(self,size=224, p=0.2, W=20):
        """
        input:
...
class FreqMask(nn.Module):
    ...
    def forward(self, img):
        ...
        for i in range(0, self.masks):
            ...
            cloned[0][f_zero:mask_end] = 0 #this is the masking part
        return cloned
...
class TimeMask(nn.Module):
    ...
    def __repr__(self) -> str:
        return f"{self.__class__.__name__}(size={self.size})(p={self.p})(T={self.T})(Masks={self.masks})"
